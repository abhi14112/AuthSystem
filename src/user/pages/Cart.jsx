...
const Cart = () => {
  ...
  const handleSetAddress = () => {
    api.post("api/profile/createaddress", singleAddress).then((res) => {
  ...
  useEffect(() => {
    api.get("api/profile/getaddress").then((res) => {
          ...
          <div className="w-full  bg-slate-200 h-max  lg:w-3/4 col-span-3">
            ...
            {addresses.map((item) => (
              <label
                ...
                className="bg-white mt-2 py-2 px-8 flex gap-4"
              >
            ...
            <div
              ...
              className="bg-white py-2 px-8 mt-2"
            >
              <p className="font-semibold cursor-pointer text-blue-500">
                + Add New Address
              </p>
            </div>
            {isOpen && (
              <div>
                ...
                <input
                  ...
                  value={singleAddress.addressLine}
                  className="w-full mb-2 border border-zinc-500 py-2 px-4 rounded-md outline-none"
                  type="text"
                ...
                <div className="flex gap-2 mb-2">
                  <input
                    ...
                    className="w-full border border-zinc-500 py-2 px-4 rounded-md outline-none"
                    type="text"
                    placeholder="City"
                    name="city"
                  />
                ...
                <button
                  ...
                  className="w-full mt-2 outline-none shadow-xl rounded-sm hover:bg-blue-600 transition-all duration-300  py-2 px-4 bg-blue-500 text-white"
                >
                  Submit
                </button>
              </div>
        ...
        <div className="w-full h-48 mt-6 lg:mt-0 lg:ml-6 bg-white shadow-md rounded-lg p-6 col-span-1 ">
          ...
          {placeOrder && (
            <button
              ...
              className="bg-blue-500 text-white rounded-md py-2 px-4 font-semibold text-xl"
            >
              Checkout
            </button>
          )}
