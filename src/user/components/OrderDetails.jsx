  ...
  return (
    <div className="p-8">
      <div
        ...
        className="p-2 cursor-pointer border border-gray-700 rounded-lg w-max"
      >
        <ArrowLeft />
      </div>
      <div className="pt-4">
          ...
          {data?.products?.map((item) => (
            <div className="py-3 flex items-center justify-between">
              <div className="flex gap-4 items-center">
                <img
                  className="w-[60px] object-cover border-1 border-slate-400 p-2  h-[60px] rounded-xl"
                  src={item?.imageUrl}
                />
        ...
        <div>
          ...
          <div className="pb-2">
            ...
            <p className="font-semibold">
              {data.address.addressLine}, {data.address.city}{" "}
