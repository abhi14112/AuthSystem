      ...
      <div className="p-4">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <button
            ...
            className="px-4 py-2 bg-blue-600 text-white text-sm font-medium cursor-pointer rounded-lg shadow-md hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400"
          >
            Add to Cart
          </button>
        </div>
